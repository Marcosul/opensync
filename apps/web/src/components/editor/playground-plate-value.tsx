/**
 * Cópia do exemplo oficial (`refs/plate/apps/www/src/registry/examples/values/playground-value.tsx`).
 * Atualize quando sincronizar o clone; use `@refs/plate/*` no IDE para comparar com o upstream.
 */
import type { Value } from 'platejs';

export const playgroundPlateRawValue: Value = [
  // Intro
  {
