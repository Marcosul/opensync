...
/**
 * Alinhado ao registo Plate (apps/www/src/registry/ui/editor.tsx).
 * @see https://github.com/udecode/plate/tree/main/apps/www/src/registry/ui
 * Cores `brand` → `primary` para combinar com o tema OpenSync.
 */
