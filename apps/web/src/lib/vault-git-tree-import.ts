 ...
 * Mantém corpos em `prev` para paths permitidos até `prefetchLazyGitVaultBlobs` (com
 * `forceBlobRefetch`) trazer revisões novas — evita apagar a UI por corrida com `startTransition`.
 */
